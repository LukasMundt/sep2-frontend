...
export default function RootLayout() {
    return (
        <>
            <nav className="flex w-full px-[21px] md:px-[55px] xl:px-[89px] 2xl:px-[144px] py-[21px] justify-between bg-background">
                <div className="flex gap-[13px] items-center dark:fill-white">
                    <svg xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 448 512" className="size-[34px]" >
                        <path
                    ...
                    <span className="sr-only">Icon of a running man</span>
                    <h1 className="text-3xl sr-only sm:not-sr-only uppercase">speedruns.com</h1>
                </div>
