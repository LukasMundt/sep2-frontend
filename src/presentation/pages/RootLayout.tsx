...
export default function RootLayout() {
    return (
        <>
            <nav
                className="flex w-full px-[21px] md:px-[55px] xl:px-[89px] 2xl:px-[144px] py-[21px] justify-between bg-background">
                <div className="flex gap-[13px] items-center dark:fill-white">
                    <Link to="/">
                        ...
                        <span className="sr-only">Icon of a running person</span>
                    </Link>
